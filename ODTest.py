...
print('Start Download Model Test')
...
print('Finish Download Model Test')
...
save_slot = 2
gcp_folder = config["gcp_folder"] + '/test'
...
print('Start Loading Model Test')
...
input_mean = 127.5
input_std = 127.5
print('Finish Loading Model Test')

print('Start Read Camera 1st Test')
# Open video file
...
print('Finish Read Camera 1st Test')
